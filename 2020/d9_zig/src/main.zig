...
test "parse input" {
    ...
    try testing.expectEqual(numbers[0], 35);
    try testing.expectEqual(numbers[19], 576);
}
...
test "is sum" {
    ...
    try testing.expect(isSum(40, &numbers));
    try testing.expectEqual(isSum(70, &numbers), false);
}
...
test "test input" {
    ...
    try testing.expectEqual(number, 127);
    ...
    try testing.expectEqual(weak_sum, 62);
}
...
test "solve part 1" {
    ...
    try testing.expectEqual(number, 70639851);
}
...
test "solve part 2" {
    ...
    try testing.expectEqual(weak_sum, 8249240);
}
